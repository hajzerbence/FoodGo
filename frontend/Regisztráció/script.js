...
document.addEventListener('DOMContentLoaded', () => {
    document.getElementById('regisztracioGomb').addEventListener('click', async () => {
        ...
        //jelszó regex: minimum 8 karakter, legalább egy nagybetű, egy kisbetű, egy szám és egy speciális karakter; bármilyen karaktert elfogad
        const jelszoRegex = /^(?=.*[a-záéíóöőúüűÁÉÍÓÖŐÚÜŰ])(?=.*[A-ZÁÉÍÓÖŐÚÜŰ])(?=.*\d)(?=.*[^\p{L}\p{N}\s]).{8,}$/u;
